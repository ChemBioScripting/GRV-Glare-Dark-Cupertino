...
as_initiate_button = <Primary><Alt>Button1
as_rotate_left_key = <Primary><Alt>Left
as_rotate_left_button = Disabled
as_rotate_right_key = <Primary><Alt>Right
as_rotate_right_button = Disabled
as_rotate_left_window_key = <Shift><Primary><Alt>Left
as_rotate_left_window_button = Disabled
as_rotate_right_window_key = <Shift><Primary><Alt>Right
...
s0_top_color = #141414ff
s0_bottom_color = #141414ff
s0_top_images = /usr/share/pixmaps/fedora-logo-sprite.png;
s0_bottom_images = /usr/share/pixmaps/fedora-logo-sprite.png;
...
as_left_key = <Primary><Alt>Left
as_left_button = Disabled
as_right_key = <Primary><Alt>Right
as_right_button = Disabled
as_up_key = <Primary><Alt>Up
as_up_button = Disabled
as_down_key = <Primary><Alt>Down
as_down_button = Disabled
as_next_key = Disabled
as_next_button = Disabled
as_prev_key = Disabled
as_prev_button = Disabled
as_left_window_key = <Shift><Primary><Alt>Left
as_right_window_key = <Shift><Primary><Alt>Right
as_up_window_key = <Shift><Primary><Alt>Up
as_down_window_key = <Shift><Primary><Alt>Down
...
as_next_all_key = <Primary><Alt>Tab
as_prev_all_button = Disabled
as_prev_all_key = <Shift><Primary><Alt>Tab
...
[grid]
as_put_center_key = <Primary><Alt>KP_5
as_put_left_key = <Primary><Alt>KP_4
as_put_right_key = <Primary><Alt>KP_6
as_put_top_key = <Primary><Alt>KP_8
as_put_bottom_key = <Primary><Alt>KP_2
as_put_topleft_key = <Primary><Alt>KP_7
as_put_topright_key = <Primary><Alt>KP_9
as_put_bottomleft_key = <Primary><Alt>KP_1
as_put_bottomright_key = <Primary><Alt>KP_3

[core]
as_active_plugins = core;imgjpeg;svg;decoration;minimize;clone;resize;wobbly;water;screenshot;png;obs;place;shift;video;fade;cube;rotate;cubeaddon;switcher;scale;move;3d;
...
as_raise_window_button = <Primary>Button6
...
as_show_desktop_key = <Primary><Alt>d
...
as_toggle_window_shaded_key = <Primary><Alt>s
...
as_switch_filter_key = <Primary><Super>s
...
[cube]
as_unfold_key = <Primary><Alt>Down
...
s0_images = /usr/share/pixmaps/fedora-logo;
s0_adjust_image = true
s0_skydome = true
s0_skydome_image = Material-Wallpapers-2048x1638.jpg
